...
const PartnershipManagement = () => {
  ...
  const editHeading = async (e) => {
    ...
    try {
      ...
      const response = await baseURL.patch(
        "/api/headingfornewspatnership/updateallheading",
        formDatas,
        {
          headers: {
  ...
  const addNewPatners = async (e) => {
    e.preventDefault();
    if (
      !patnershipDatas.companylogo ||
      !patnershipDatas.description ||
      !patnershipDatas.companyname
    ) {
  ...
  const editAPartnerDetails = async (e) => {
    ...
    if (
      !editPartnershipDatas.description ||
      !editPartnershipDatas.companyname
    ) {
  ...
  return (
    <div className="bg-white w-full">
      <div className="py-[40px] px-[30px] grid gap-[30px]">
            ...
            >
              <input
                ...
                onChange={(e) =>
                  setHeading({
                    ...heading,
                    partnershipSubHeading: e.target.value,
                  })
                }
        ...
        <div
          id="editFormPartner"
          className="bg-white partnerContainer border rounded-lg grid p-[40px] gap-[40px]"
        >
          {!isEditMode ? (
            <>
                  ...
                  <div className="grid w-1/3 gap-[30px]">
                    ...
                    <div className="relative">
                      <div className="text-[12px] font-semibold text-red-400 mb-2">
                        * Please upload an image of aspect ratio between 1:1 and
                        2:1 (eg: 600px * 600px or 1200px * 600px) with
          ...
          <div className="grid gap-[30px]">
            {allPartnersData.length > 0
              ? allPartnersData.map((partners, index) => (
                  <div
                    key={index}
                    className="bg-white border partnerContainer rounded-lg  p-[20px] "
                  >
                    <form className="flex gap-[25px]">
                      ...
                      <div className="grid gap-[40px]">
                        ...
                        >
                          <img src="/assets/svg/deleteimg.svg" alt="" />
                        </div>
                      </div>
                    </form>
                  </div>
