...
function AddInterns() {
  ...
  const handleSubmit = async e => {
    ...
    if (!empIDPattern.test(empID)) {
      toast.error(
        "Employee ID must start with 'TPEID' followed by 6 digits (e.g., TPEID123456)."
      );
    ...
    try {
      ...
      if (error.response) {
        ...
        const message =
          error.response.data.message || 'Failed to save intern details.';
        toast.error(message);
      } else {
      ...
      <form className="row g-4" onSubmit={handleSubmit}>
        <div className="d-flex align-items-center  mb-4 ">
          <div className="me-4 pt-10 ">
            <h2 className="mb-4 text-[22px]">
              {id ? 'Edit Intern Details' : 'Add Intern Details'}
            </h2>
            <div
          ...
          <div className="mt-5 flex-grow-1 row justify-evenly ">
            ...
            <div className="col-md-3">
              <label className="form-label   font-md text-[15px]">
                Employee ID
              </label>
              <input
                type="text"
        ...
        <div className="flex justify-between ">
          <div className=" flex flex-col  p-8 w-[310px] ">
            ...
            <div className="mb-3">
              <label
                className="form-label text-[15px] font-md "
                htmlFor="phone"
              >
                Phone Number
              </label>
