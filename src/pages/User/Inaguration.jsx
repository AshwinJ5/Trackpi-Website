                    ...
                    <div className="inagurationSecond  flex w-full ">
                        <div className="w-1/2  flex flex-col items-center justify-around firstDivIng">
                            <div className="w-full  2xl:pt-[40px] 2xl:ps-[40px] pt-[20px] ps-[20px]">
                                <img className="2xl:w-[150px] xl:w-[120px] w-[100px]  " src={logo} alt="" />
                            </div>
                            <div className="grid w-full ms-[40px]  font-semibold">
                                <div className="k2d  text-left  xl:text-[80px] 2xl:text-[100px] text-[55px]">GRAND</div>
                            ...
                            <div className="flex xl:gap-[30px] lg:gap-[20px] ms-[40px] w-full mb-[30px]">
                                <div>
                                    <img
                                        className="xl:w-[170px]  w-[170px] aspect-[170/222] inagurationPerson "
                                        src={img2}
                                        alt=""
                                    />
                                </div>
                                <div className="grid lg:gap-[10px]  w-[412px]">
                                    <div className="grid gap-[10px]">
                                        <div className="xl:text-[44px] lg:text-[36px] font-semibold lateef">
                                            Dr. Shajahan Aboobacker
                                        </div>
                                        <div className="interFont font-medium xl:text-[24px] lg:text-[18px]">
                                            Business Coach & <br />
                                    ...
                                    <NavLink
                                        to={"/"}
                                        className="xl:text-[24px] text-[20px] interFont font-bold xl:max-w-[304px] max-w-[260px] h-[56px] xl:h-[64px] bg-gradient-to-r from-[#FEDC3F] via-[#FE8900] to-[#FE8900] rounded-[37px] text-white flex items-center justify-center gap-[10px]"
                                    >
                        ...
                        <div className="w-1/2 py-[30px] flex flex-col items-center justify-around secondDivIng">
                            <div className="grid  gap-1 text-center ">
                                <div className="2xl:text-[40px] xl:text-[35px] text-[28px] montserrat font-bold ">
                                    Welcome to <span className="text-white">Trackpi</span>
                                </div>
                                <div className="2xl:text-[28px] xl:text-[24px] text-[20px]  righteous">
                            ...
                            <div className="grid gap-[15px] text-center">
                                ...
                                <div className="xl:text-[22px] text-[18px] encodeSans">
                        ...
                        <div className="  grid items-center justify-center items-center thirdDivIng w-full">
                            ...
                            <div className="flex gap-[23px] ms-[60px] w-full mb-[30px]">
                                <div>
