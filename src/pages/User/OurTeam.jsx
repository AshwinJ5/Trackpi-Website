        ...
        <>
            <section className="flex justify-center items-center  h-full w-full px-4 ">
                <div className="  flex flex-col items-center">
                    <h1 className="text-[20px] md:text-4xl lg:text-5xl 2xl:text-6xl text-[#FF9D00] font-bold hiring_heading">
                        Who We Are?
                    </h1>
                </div>
            </section>
                ...
                >
                    <div className="md:w-1/2">
                        ...
                        <motion.p
                            ...
                            transition={{ duration: 0.8 }}
                        >
                            Trackpi is one of the best business consultants in Kerala, assisting clients in fulfilling their
                            objectives. Based in Kochi, our team is highly experienced in developing strategies that promote
                            growth and development. With our expert commercial development consulting services, we help
                            businesses thrive in a competitive environment. As one of the leading business consultants in
                            Kerala, we confidently position ourselves as the most qualified firm to excel in this field.
                        </motion.p>
                    </div>
                ...
                >
                    ...
                    <div className="md:w-1/2">
                        ...
                        <motion.p
                            ...
                            transition={{ duration: 0.8 }}
                        >
                            The Trackpi team is dedicated to ensuring the success of your business. Each team member brings
                            extensive experience and a range of skills tailored to meet your business needs. We work
                            collaboratively to achieve excellent results for your company, helping you reach your goals and
                            expand your operations. Our commitment to excellence ensures that we make significant strides
                ...
                >
                    <div className="flex flex-col w-full md:w-1/2">
                        ...
                        <motion.p
                            ...
                            transition={{ duration: 0.8 }}
                        >
                            Trackpi is excited to offer you an opportunity to join us, even without prior experience. If
                            you're looking to earn additional income, look no further—Trackpi provides the perfect platform
                            to get started. All you need is passion and skills to embark on your journey.
                        </motion.p>
                        <motion.div
                            ...
                            transition={{ duration: 0.8 }}
                        >
                            Trackpi welcomes freelancers at various stages of life—students, working professionals, and even
                            senior citizens seeking self-enhancement and accomplishment. Work from home and potentially earn
                            more while being part of a thriving freelance community. Join us today to take advantage of
                            opportunities that foster your growth and development while contributing to a diverse and
                            dynamic community.
                            <br />
