        ...
        >
          <div className="md:w-1/2">
            ...
            <div className="flex justify-center px-2 ">
              <motion.img
                src="/assets/images/business-consultants-kerala-modern-office-collaboration.jpg"
                alt="Team Image"
      ...
      >
        ...
        >
          <div className="md:w-1/2 flex md:justify-start hidden md:block">
            <motion.img
              src="/assets/images/business-consultant-kerala-professionals-formal-photo.jpg"
              alt="Team Image"
      ...
      >
        ...
        >
          <div className="flex flex-col w-full md:w-1/2">
            ...
            <div className="flex justify-center px-2">
              <motion.img
                src="/assets/images/business-consulting-services-professionals-meeting.jpg"
                alt=""
