          ...
          <div className="hidden md:block w-full">
            <div className="flex flex-row justify-between items-center text-2xl xl:text-xl ">
              ...
              <div>
                ...
                <p className="font-bold text-sm md:text-base lg:text-lg">{employeeData.empID || "EMP001"}</p>
              </div>
              <div>
                <p className="email text-xs md:text-sm lg:text-base">Email</p>
                <p className="font-bold text-sm md:text-base lg:text-lg">{employeeData.email || "paulwalker@gmail.com"}</p>
              </div>
            </div>
          </div>
