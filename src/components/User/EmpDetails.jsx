        ...
        <>
                ...
                <div className="w-full flex flex-row justify-center items-center gap-4 md:gap-5">
                    ...
                    <div className="hidden md:block w-full">
                        <div className="flex flex-row justify-between items-center text-2xl xl:text-xl ">
                            ...
                            <div>
                                <p className="text-xs md:text-sm lg:text-base">Employee ID</p>
                                <p className="font-bold text-sm md:text-base lg:text-lg">
                                    {employeeData.empID || "EMP001"}
                                </p>
                            </div>
                            <div>
                                <p className="email text-xs md:text-sm lg:text-base">Email</p>
                                <p className="font-bold text-sm md:text-base lg:text-lg">
                    ...
                    <div className="md:hidden w-full flex flex-col justify-between items-start md:flex-row lg:flex-row md:text-2xl xl:text-xl">
                        ...
                        <div className="flex flex-row md:flex-col" style={{ lineHeight: "1px" }}>
                            <p className="email text-xs md:text-sm lg:text-base" style={{ margin: 0 }}>
                                Email
                            </p>
                            <p className="font-bold text-sm md:text-base lg:text-lg" style={{ margin: 0 }}>
                                {employeeData.email || "paulwalker@gmail.com"}
            ...
            <div className="bot flex justify-center gap-12 mt-8 sm:mt-16  md:mt-3 2xl:mt-8 px-10 py-2 md:py-0 mb-3  sm:mb-5 md:mb-3 lg:mb-3 xl:mb-0 ">
                {socialMediaLink.facebook && (
                    <Link target="_blank" to={`${socialMediaLink.facebook}`} className="flex justify-center items-center">
                        <RiFacebookCircleLine size={24} className=" ico text-yellow-500 cursor-pointer" />
                    </Link>
                )}
                {socialMediaLink.instagram && (
                    <Link target="_blank" to={`${socialMediaLink.instagram}`} className="flex justify-center items-center">
                        <IoLogoInstagram size={24} className=" ico text-yellow-500 cursor-pointer" />
                    </Link>
                )}
                {socialMediaLink.likedin && (
                    <Link target="_blank" to={`${socialMediaLink.likedin}`} className="flex justify-center items-center">
                        <TbBrandLinkedin size={24} className="ico text-yellow-500 cursor-pointer" />
                    </Link>
                )}
                {socialMediaLink.twitter && (
                    <Link target="_blank" to={`${socialMediaLink.twitter}`} className="flex justify-center items-center">
